...
namespace Alice {
	...
	void DeviceInfo::SetSystemInfo(int core_count, const char * device_info, const char *cpu_type, const char * system_name, int memorysize) {
		sCPUCoreCount = core_count;
		strcpy(sDeviceInfo, device_info);
